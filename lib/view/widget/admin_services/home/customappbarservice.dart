...
class CustomBottonAppBarService extends StatelessWidget {
  const CustomBottonAppBarService({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    return GetBuilder<ServiceScreenControllerImp>(
